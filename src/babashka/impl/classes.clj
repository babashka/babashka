...
;; Generated by poc-logs/precise-methods.clj from the tools.deps sources
;; under resources/src/babashka: the public methods those sources call, and
;; <init> where they construct the class.
(def tools-deps-methods
  (quote {org.eclipse.aether.version.Version
 {:methods [{:name "toString", :parameterTypes []}]},
 org.codehaus.plexus.util.xml.Xpp3Dom
 {:methods
  [{:name "getChild", :parameterTypes ["int"]}
   {:name "getChild", :parameterTypes ["java.lang.String"]}
   {:name "getChildren", :parameterTypes []}
   {:name "getChildren", :parameterTypes ["java.lang.String"]}
 ...
 {:methods
  [{:name "getExceptions", :parameterTypes []}
   {:name "getVersion", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 org.eclipse.aether.artifact.DefaultArtifact
 {:methods
  [{:name "getArtifactId", :parameterTypes []}
   {:name "getClassifier", :parameterTypes []}
   {:name "getExtension", :parameterTypes []}
 ...
 {:methods
  [{:name "create", :parameterTypes []}
   {:name "getEffectiveSettings", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 org.eclipse.aether.resolution.ArtifactDescriptorRequest
 {:methods
  [{:name "getArtifact", :parameterTypes []}
   {:name "toString", :parameterTypes []}
 ...
 {:methods
  [{:name "getArtifact", :parameterTypes []}
   ...
   {:name "<init>", :parameterTypes []}
   {:name "<init>",
    :parameterTypes ["org.eclipse.aether.graph.DependencyNode"]}
   {:name "<init>",
    :parameterTypes
    ["org.eclipse.aether.artifact.Artifact"
     "java.util.List"
 ...
 {:methods
  [{:name "setSystemProperties",
   ...
   {:name "setUserSettingsFile", :parameterTypes ["java.io.File"]}
   {:name "toString", :parameterTypes []}
   {:name "<init>", :parameterTypes []}]},
 org.eclipse.aether.artifact.Artifact
 {:methods
 ...
 {:methods
  [{:name "newInstance", :parameterTypes []}
   {:name "toString", :parameterTypes []}
   {:name "<init>", :parameterTypes []}]},
 org.apache.maven.settings.building.SettingsBuildingResult
 {:methods [{:name "getEffectiveSettings", :parameterTypes []}]},
 org.eclipse.aether.repository.RemoteRepository$Builder
 {:methods
  [{:name "build", :parameterTypes []}
   {:name "setReleasePolicy",
    :parameterTypes ["org.eclipse.aether.repository.RepositoryPolicy"]}
   {:name "setSnapshotPolicy",
    :parameterTypes ["org.eclipse.aether.repository.RepositoryPolicy"]}
   {:name "toString", :parameterTypes []}
   {:name "<init>",
    :parameterTypes ["org.eclipse.aether.repository.RemoteRepository"]}
   {:name "<init>",
    :parameterTypes
 ...
 {:methods
  [{:name "getArtifactId", :parameterTypes []}
   {:name "getClassifier", :parameterTypes []}
   {:name "getExclusions", :parameterTypes []}
   {:name "getGroupId", :parameterTypes []}
   {:name "getScope", :parameterTypes []}
   {:name "getVersion", :parameterTypes []}
   {:name "isOptional", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 org.apache.maven.model.building.ModelBuildingResult
 {:methods [{:name "getEffectiveModel", :parameterTypes []}]},
 org.apache.maven.model.building.ModelSource
 {:methods [{:name "getInputStream", :parameterTypes []}]},
 ...
 {:methods
  [{:name "main", :parameterTypes ["java.lang.String[]"]}
   {:name "parseVersion", :parameterTypes ["java.lang.String"]}
   {:name "toString", :parameterTypes []}
   {:name "<init>", :parameterTypes []}]},
 org.apache.maven.model.PluginExecution
 {:methods
  [{:name "getConfiguration", :parameterTypes []}
   {:name "getGoals", :parameterTypes []}
 ...
 {:methods
  [{:name "build", :parameterTypes []}
   ...
   {:name "transferListener",
    :parameterTypes ["org.eclipse.aether.transfer.TransferListener"]}
   {:name "withEffectiveSettings",
    :parameterTypes ["java.lang.Object"]}
   {:name "withLocalRepositoryOverride",
    :parameterTypes ["java.nio.file.Path"]}
   {:name "withUserSettings", :parameterTypes ["boolean"]}]},
 ...
 {:methods
  [{:name "getId", :parameterTypes []}
   {:name "toString", :parameterTypes []}
   {:name "<init>", :parameterTypes ["java.io.File"]}
   {:name "<init>", :parameterTypes ["java.lang.String"]}
   {:name "<init>",
    :parameterTypes ["java.io.File" "java.lang.String"]}]},
 org.eclipse.aether.transfer.TransferEvent
 {:methods
  [{:name "getException", :parameterTypes []}
   {:name "getResource", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 ...
 {:methods
  [{:name "getArtifactId", :parameterTypes []}
   ...
   {:name "getGroupId", :parameterTypes []}
   {:name "getId", :parameterTypes []}
   {:name "getLicenses", :parameterTypes []}
   {:name "getName", :parameterTypes []}
   {:name "getParent", :parameterTypes []}
   {:name "getProperties", :parameterTypes []}
 ...
 {:methods
  [{:name "newResolutionRepositories",
    :parameterTypes
 ...
 {:methods
  [{:name "setModelResolver",
   ...
   {:name "setModelSource",
    :parameterTypes ["org.apache.maven.model.building.ModelSource"]}
   {:name "setSystemProperties",
    :parameterTypes ["java.util.Properties"]}
   {:name "toString", :parameterTypes []}
   {:name "<init>", :parameterTypes []}
 ...
 {:methods
  [{:name "getArtifact", :parameterTypes []}
   {:name "getExceptions", :parameterTypes []}
   {:name "isMissing", :parameterTypes []}
   {:name "isResolved", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 org.apache.maven.model.Resource
 {:methods
  [{:name "getDirectory", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 eu.maveniverse.maven.mima.context.Context
 {:methods
  [{:name "getRuntime", :parameterTypes []}
   {:name "lookup", :parameterTypes []}
   {:name "repositorySystem", :parameterTypes []}
   {:name "repositorySystemSession", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 ...
 {:methods
  [{:name "getInputStream", :parameterTypes []}
   {:name "getUrl", :parameterTypes []}
   {:name "toString", :parameterTypes []}
   {:name "<init>", :parameterTypes ["java.net.URL"]}]},
 ...
 {:methods
  [{:name "getMessage", :parameterTypes []}
   {:name "printStackTrace", :parameterTypes []}
   {:name "printStackTrace", :parameterTypes ["java.io.PrintStream"]}
   {:name "printStackTrace", :parameterTypes ["java.io.PrintWriter"]}
   {:name "toString", :parameterTypes []}]},
 ...
 {:methods
  [{:name "getArtifactId", :parameterTypes []}
   {:name "getConfiguration", :parameterTypes []}
   {:name "getDependencies", :parameterTypes []}
   {:name "getExecutions", :parameterTypes []}
   {:name "getGoals", :parameterTypes []}
   {:name "getGroupId", :parameterTypes []}
   {:name "getId", :parameterTypes []}
   {:name "getVersion", :parameterTypes []}
 ...
 {:methods
  [{:name "getExceptions", :parameterTypes []}
   {:name "getHighestVersion", :parameterTypes []}
   {:name "getVersions", :parameterTypes []}
   {:name "toString", :parameterTypes []}]},
 org.eclipse.aether.transfer.TransferResource
 {:methods
  [{:name "getFile", :parameterTypes []}
   {:name "getRepositoryId", :parameterTypes []}
...
(def classes
  ...
  `{:all [clojure.lang.AMapEntry ;; for proxy-super on proxied classes
    ...
    :fields [clojure.lang.PersistentQueue
             ...
             ~@(when features/tools-deps? '[org.eclipse.aether.repository.RepositoryPolicy
                                            eu.maveniverse.maven.mima.context.Runtimes
                                            java.lang.ProcessBuilder$Redirect])]
