...
format-in can be either a control string or a previously compiled format."
  ...
  [format-in]
  `(let [format-in# ~format-in
         cf# (if (string? format-in#) (#'babashka.impl.clojure.pprint/cached-compile format-in#) format-in#)]
     (fn [& args#]
       (let [navigator# (#'babashka.impl.clojure.pprint/init-navigator args#)]
         (#'babashka.impl.clojure.pprint/execute-format cf# navigator#)))))
