...
(in-ns 'babashka.impl.clojure.pprint)
...
(def ^{:private true} write-option-table
     {;:array            *print-array*
      :base             #'babashka.impl.clojure.pprint/*print-base*,
      ;;:case             *print-case*,
      :circle           #'babashka.impl.clojure.pprint/*print-circle*,
      ;;:escape           *print-escape*,
      ;;:gensym           *print-gensym*,
      :length           #'clojure.core/*print-length*,
      :level            #'clojure.core/*print-level*,
      :lines            #'babashka.impl.clojure.pprint/*print-lines*,
      :miser-width      #'babashka.impl.clojure.pprint/*print-miser-width*,
      :dispatch         #'babashka.impl.clojure.pprint/*print-pprint-dispatch*,
      :pretty           #'babashka.impl.clojure.pprint/*print-pretty*,
      :radix            #'babashka.impl.clojure.pprint/*print-radix*,
      :readably         #'clojure.core/*print-readably*,
      :right-margin     #'babashka.impl.clojure.pprint/*print-right-margin*,
      :suppress-namespaces #'babashka.impl.clojure.pprint/*print-suppress-namespaces*})
...
and :suffix."
  ...
  (let [[options body] (parse-lb-options #{:prefix :per-line-prefix :suffix} args)]
    `(do (if (#'babashka.impl.clojure.pprint/level-exceeded) 
           (.write ^java.io.Writer *out* "#")
           (do 
             (push-thread-bindings {#'babashka.impl.clojure.pprint/*current-level*
                                    (inc (var-get #'babashka.impl.clojure.pprint/*current-level*))
                                    #'babashka.impl.clojure.pprint/*current-length* 0})
             (try  
              (#'babashka.impl.clojure.pprint/start-block *out*
                           ~(:prefix options) ~(:per-line-prefix options) ~(:suffix options))
              ~@body
              (#'babashka.impl.clojure.pprint/end-block *out*)
              (finally 
               (pop-thread-bindings)))))
         nil)))
