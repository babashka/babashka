...
(def cheshire-core-namespace
  {'encode (copy-var generate-string tns {:copy-meta-from json/generate-string})
   'generate-string (copy-var generate-string tns {:copy-meta-from json/generate-string})
   'encode-stream (copy-var generate-stream tns {:copy-meta-from json/generate-stream})
   'generate-stream (copy-var generate-stream tns {:copy-meta-from json/generate-stream})
   ;;'encode-smile (copy-var json/encode-smile tns)
   ;;'generate-smile (copy-var json/generate-smile tns)
   'decode (copy-var parse-string tns {:copy-meta-from json/parse-string})
   'parse-string (copy-var parse-string tns {:copy-meta-from json/parse-string})
   'parse-string-strict (copy-var parse-string-strict tns {:copy-meta-from json/parse-string-strict})
   ;;'parse-smile (copy-var json/parse-smile tns)
   'parse-stream (copy-var parse-stream tns {:copy-meta-from json/parse-stream})
   'parse-stream-strict (copy-var parse-stream-strict tns {:copy-meta-from json/parse-stream-strict})
   'parsed-seq (copy-var parsed-seq tns {:copy-meta-from json/parsed-seq})
...
(def cheshire-generate-namespace
  {'add-encoder (copy-var gen/add-encoder gns)
   'encode-str  (copy-var gen/encode-str gns)})
